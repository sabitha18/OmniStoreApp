...
/**
 * Created by Bhupendra on 9/22/2017.
 */
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                ...
                itemView.setTextColor(getResources().getColor(R.color.tertiary_text));
            }
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(Color.parseColor("#e6d8d8d8"));
