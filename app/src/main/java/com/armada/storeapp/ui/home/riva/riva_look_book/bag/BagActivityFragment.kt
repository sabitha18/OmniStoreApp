...
@AndroidEntryPoint
class BagActivityFragment : Fragment() {
    ...
    private var bagActivity: BagActivity? = null
    ...
    override fun onCreateView(
        ...
        bagActivity = (activity as BagActivity)
        setEmptyPage()
        init()
        setOnClickListener()
        return binding.root
    ...
    private fun init() {
        ...
        binding.swipeRefreshCart.setOnRefreshListener {
            if (strUserId != "") {
                ...
                val intent = Intent(bagActivity, RivaLoginActivity::class.java)
    ...
    private fun setOnClickListener() {
        ...
        binding.imageViewBarcodeScan.setOnClickListener {
            val intent = Intent(bagActivity, OmniItemScannerActivity::class.java)
            startActivity(intent)
        }
...
//                    )
                adapter =
                    BagItemAdapter(bagActivity!!, selectedCurrency, null)
...
//            binding.txtTotalAmount?.text = (Utils.getPriceFormatted(strSubtotal))
    ...
    override fun onResume() {
        ...
        strUserId =
            SharedpreferenceHandler(activity!!).getData(
    ...
    fun updateBadgeCart() {
        ...
        bagActivity?.setBagCount(cartCount)
