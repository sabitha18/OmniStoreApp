...
import com.armada.storeapp.databinding.ActivityProductDetailsBinding
import com.armada.storeapp.databinding.TestDetailsBinding
...
import com.armada.storeapp.ui.home.riva.riva_look_book.products.product_details.adapter.ImagePagerAdapter
import com.armada.storeapp.ui.home.riva.riva_look_book.products.product_details.adapter.LikeImagePagerAdapter
import com.armada.storeapp.ui.home.riva.riva_look_book.products.product_details.adapter.MatchedProductAdapter
import com.armada.storeapp.ui.home.riva.riva_look_book.products.product_details.adapter.RecentProductAdapter
import com.armada.storeapp.ui.home.riva.riva_look_book.products.product_details.interfaces.OnAttributeSelectListener
import com.armada.storeapp.ui.utils.AnimatorListener
...
class ProductDetailsActivity : BaseActivity() {
    ...
    lateinit var binding: TestDetailsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = TestDetailsBinding.inflate(layoutInflater)
...
//        binding.btnAddToBag.visibility=View.GONE
    ...
    fun setImageAdapter() {
        ...
        binding.pager.adapter = ImagePagerAdapter(this, arrListGalleryImages!!)
    ...
    fun setMatchWithProducts() {
        ...
        if (productData?.related != null && productData?.related!!.size > 0) {
            ...
            val adapter = MatchedProductAdapter(
                selectedCurrency,
                productheight,
                screenWidth,
                this@ProductDetailsActivity,
...
//                    resources.getString(R.string.select) + " " + attributeIdType1
                ...
                if (!arrListAttr1.isNullOrEmpty()) {
                    binding.txtAttribute1.visibility = View.VISIBLE
                    binding.rvAttribute1.visibility = View.VISIBLE
                    configAdapter1 = ConfigAdapter(this@ProductDetailsActivity,
                        arrListAttr1 as ArrayList<ProductDetailsAttribute>,
                        arrListConfig[0].attribute_code
                            ?: "",
                        object : OnAttributeSelectListener {
...
//                }
    ...
    fun showProductAddedView() {
        ...
        binding.toolbar1.txtCartCount.setText(cartCount.toString())
    }
...
//                    })
    ...
    private fun updateBadgeToCart(show_btn: Boolean) { //get count of cart
        val cartCount = sharedpreferenceHandler.getData(SharedpreferenceHandler.CART_COUNT, 0)
        if (cartCount > 0) {
            if (show_btn) {
...
//        productDetailsViewModel.cartCount.observe(this) {
//
//        }
    ...
    private fun setRelatedProducts() {
        if (!arrListRecent.isNullOrEmpty() && arrListRecent.size > 0) {
            //arrListRecent.reverse()
            val adapter = RecentProductAdapter(
                selectedCurrency,
                recentWidth,
                recentHeight,
                productWidthHalf,
...
//    }
    ...
    private fun showProgress() {
        ...
        if (!this@ProductDetailsActivity.isFinishing) {
            if (loading == null) {
                loading = Dialog(this@ProductDetailsActivity, R.style.TranslucentDialog)
