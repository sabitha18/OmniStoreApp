...
class ToLocationSpinnerAdapter(
    ctx: Context,
    spinnerList: ArrayList<ToLocationListResponse.ToLocationListResponseItem>
) : ArrayAdapter<ToLocationListResponse.ToLocationListResponseItem>(ctx, 0, spinnerList) {
