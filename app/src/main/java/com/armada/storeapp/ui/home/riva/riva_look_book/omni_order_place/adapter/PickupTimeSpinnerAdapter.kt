...
import com.armada.storeapp.data.model.response.GetTimeSlotResponse
import com.armada.storeapp.data.model.response.TimeSlot

class PickupTimeSpinnerAdapter(
    ctx: Context,
    spinnerList: ArrayList<TimeSlot>
