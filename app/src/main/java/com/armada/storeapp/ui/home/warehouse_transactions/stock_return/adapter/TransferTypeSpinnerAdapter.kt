...
class TransferTypeSpinnerAdapter(
    ctx: Context,
    spinnerList: ArrayList<TransferTypeResponseModel.TransferTypeResponseModelItem>
) : ArrayAdapter<TransferTypeResponseModel.TransferTypeResponseModelItem>(ctx, 0, spinnerList) {
