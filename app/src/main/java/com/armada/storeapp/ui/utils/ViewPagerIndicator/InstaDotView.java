...
public class InstaDotView extends View {
    ...
    public Paint activePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    public Paint inactivePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    ...
    private void setup(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            activeDotSize = ta.getDimensionPixelSize(R.styleable.InstaDotView_dot_activeSize, resources.getDimensionPixelSize(R.dimen.seven_dp));
            inactiveDotSize = ta.getDimensionPixelSize(R.styleable.InstaDotView_dot_inactiveSize, resources.getDimensionPixelSize(R.dimen.seven_dp));
            mediumDotSize = ta.getDimensionPixelSize(R.styleable.InstaDotView_dot_mediumSize, resources.getDimensionPixelSize(R.dimen.five_dp));
            smallDotSize = ta.getDimensionPixelSize(R.styleable.InstaDotView_dot_smallSize, resources.getDimensionPixelSize(R.dimen.five_dp));
            dotMargin = ta.getDimensionPixelSize(R.styleable.InstaDotView_dot_margin, resources.getDimensionPixelSize(R.dimen.ten_dp));
    ...
    public void setStartPosX(int startPosX) {
        ...
        //  System.out.println("Current start "+startPosX);
    }
    ...
    public int getInactiveDotStartX() {
        return inactiveDotSize + dotMargin;
    }

    public int getMediumDotStartX() {
        return mediumDotSize + dotMargin;
    }

    public int getSmallDotStartX() {
        return smallDotSize + dotMargin;
    }

    public int getActiveDotRadius() {
    ...
    public int getMediumDotRadius() {
        return mediumDotSize / 2;
    }

    public int getSmallDotRadius() {
    ...
    private void setupNormalDots() {
      ...
      /*  if (previousPage>=noOfPages)
            dotsList.get(0).setState(Dot.State.INACTIVE);
        else dotsList.get(previousPage).setState(Dot.State.INACTIVE);*/

        for (int i = 0; i < noOfPages; i++) {
            dotsList.get(i).setState(Dot.State.INACTIVE);
        }
